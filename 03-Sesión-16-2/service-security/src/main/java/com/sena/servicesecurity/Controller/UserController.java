...
public class UserController extends ABaseController<User, IUserService> {
	...
	@GetMapping("/login")
	public ResponseEntity<ApiResponseDto<Optional<IUserDto>>> show(@RequestParam String username,
		...
		try {
			...
			return ResponseEntity.internalServerError()
					.body(new ApiResponseDto<Optional<IUserDto>>(e.getMessage(), null, false));
		}
	}
}
